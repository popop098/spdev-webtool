...
import {faEye,faEyeSlash,faCopy,faCheck,faExclamationCircle} from "@fortawesome/free-solid-svg-icons";
...
export default function LogBar(){
    ...
    //     return(
    //         <>
    //             <div className="card col-span-2 row-span-2 shadow-2xl bg-base-200">
    //                 <div className="card-body">
    //                     <p className="card-title">URL 단축 API Key</p>
    //                     <pre className="card-text">
    ...
    return(
        <>
            <div className="card col-span-2 row-span-2 shadow-2xl bg-base-200">
                <div className="card-body">
                    <p className="card-title">사용기록</p>
                    <p className="card-text">
                        사용자의 최근 5건의 기록을 보여줍니다.
                    </p>
