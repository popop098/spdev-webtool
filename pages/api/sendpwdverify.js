                  ...
                  <tbody>
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:helvetica;font-size:20px;line-height:1;text-align:left;color:#F45E43;">WebTool 비밀번호를 찾기위한 이메일 인증코드입니다.</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:helvetica;font-size:15px;line-height:1;text-align:left;color:#F45E43;">인증코드: ${req.body.code}</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:helvetica;font-size:10px;line-height:1;text-align:center;color:#a6a6a6;">만일 인증요청을 하지않았다면 이 메일을 무시해주세요.</div>
                      </td>
                    </tr>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="font-family:helvetica;font-size:10px;line-height:1;text-align:center;color:#a6a6a6;">©WebTool</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
